...
def prepare_training_data(data_folder_path):
    ...
    oldFiles = np.load("newtraining/dirs.npy")
    print(newFiles, oldFiles)
    if(set(newFiles) == set(oldFiles)):
        print("EQUAL DIRECTORIES")
        faces = np.load("newtraining/faces.npy")
        labels = np.load("newtraining/labels.npy")
        return faces, labels
    print("DIFFERENT DIRECTORIES")
    np.save("newtraining/dirs.npy", newFiles)
    ...
    np.save("newtraining/faces.npy", faces)
    np.save("newtraining/labels.npy", labels)
    return faces, labels
